...
namespace LambdaRunForKidsSake
{
    public class DBAccess
    {
        ...
        public void insert_registration(DateTime timestamp,string fname, string lname, string phone,
            string email, string econtact, string ephone, char regtypes, int mop, int total)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("methodofpayment", SqlDbType.Int));
            cmd.Parameters.Add(new SqlParameter("total", SqlDbType.Int));
            cmd.Parameters[0].Value = timestamp;
            cmd.Parameters[1].Value = fname;
            cmd.Parameters[2].Value = lname;
            cmd.Parameters[3].Value = phone;
            cmd.Parameters[4].Value = email;
            cmd.Parameters[5].Value = econtact;
            cmd.Parameters[6].Value = ephone;
            cmd.Parameters[7].Value = regtypes;
            cmd.Parameters[8].Value = mop;
            cmd.Parameters[9].Value = total;
        ...
        public void insert_shirts(string fnames, string lnamess, string phones,
            int yss, int yms, int yls, int adss, int adms, int adls, int adxls, int adxxls, int adxxxls, int total)
        {
            SqlConnection conn = new SqlConnection(connstring);
            conn.Open();
